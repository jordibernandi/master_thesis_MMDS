...
for ideology in ideologies:
    ...
    command = f"CUDA_VISIBLE_DEVICES=3 python refinement_FINAL.py --prompt_file ../prompt/refinement.txt " \
              f"--generation_file ../data/output/{folder}/refinement_1_updated_after_{ideology}_08.jsonl " \
              f"--topic_file ../data/output/{folder}/refinement_1_after_{ideology}_08.md " \
              f"--out_file ../data/output/{folder}/refinement_2_after_{ideology}_05.md " \
              f"--updated_file ../data/output/{folder}/refinement_2_updated_after_{ideology}_05.jsonl " \
              f"--mapping_file ../data/output/{folder}/refinement_2_mapping_after_{ideology}_05.txt " \
