...
for ideology in ideologies:
    ...
    command = f"CUDA_VISIBLE_DEVICES=7 python refinement_FINAL.py --prompt_file ../prompt/refinement.txt " \
              f"--generation_file ../data/output/{folder}/generation_1_after_{ideology}.jsonl " \
              f"--topic_file ../data/output/{folder}/generation_1_after_{ideology}.md " \
              f"--out_file ../data/output/{folder}/refinement_1_after_{ideology}_05.md " \
              f"--updated_file ../data/output/{folder}/refinement_1_updated_after_{ideology}_05.jsonl " \
              f"--mapping_file ../data/output/{folder}/refinement_1_mapping_after_{ideology}_05.txt " \
