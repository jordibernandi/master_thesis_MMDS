...
for ideology in ideologies:
    ...
    command = f"CUDA_VISIBLE_DEVICES=3 python generation_2_FINAL.py --data ../data/output/{folder}/assignment_before_{ideology}.jsonl " \
            f"--seed_file ../data/output/{folder}/generation_1_before_{ideology}_seed.md " \
            f"--prompt_file ../prompt/generation_2.txt " \
            f"--out_file ../data/output/{folder}/generation_2_before_{ideology}_1TOPIC_ASS.jsonl " \
            f"--topic_file ../data/output/{folder}/generation_2_before_{ideology}_1TOPIC_ASS.md " \
            f"--verbose True"
